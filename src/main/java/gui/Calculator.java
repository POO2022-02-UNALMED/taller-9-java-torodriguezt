...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	...
	public Calculator(){
		...
		public String operar(String signo){
			operator = signo;
	        return number1 + signo;
	    }
        ...
        public double operaciones(String solucion){
            float n1 = Character.getNumericValue(solucion.charAt(0));
            float n2 = Character.getNumericValue(solucion.charAt(2));
            
            if (solucion.charAt(1) == '*') {
            	return n1*n2;
            }
            else if (solucion.charAt(1) == '/') {
            	return n1/n2;
            }
            else if (solucion.charAt(1) == '+') {
            	return n1+n2;
		...
		String value = b.getText();
            ...
            switch (value) {
                ...
                case "9":
                    ...
                    break;
                case "/":
                    displayText.setText(operar(value));
                    break;
                case "*":
                    displayText.setText(operar(value));
                    break;
                ...
                case "-":
                    ...
                    break;
                case "=":
                    displayText.setText(Double.toString(operaciones(displayText.getText())));
                    number1 = "";
                    number2 = "";
                    operator = "";
                    break;
